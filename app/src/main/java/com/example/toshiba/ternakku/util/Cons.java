...
public class Cons {
    ...
    public static final String CONVERSATION_URL = "https://conversation.8villages.com/1.0";
    public static final String INBOUND_URL = "http://8villages.com/inbound";

    public static final String CONSUMER_KEY = "In4uF59x4pl9oGvAfSDjg806tJo.";
    public static final String CONSUMER_SECRET = "z5ovZ_nmhIoroSpMi0OZapz_gk0kuz8_6OupByHjKPs.";

    public static final String COMUNITY_ID = "5428e4b344752ddb3481b857";
    public static final String COMUNITY_NAME = "Gembala";

    public static final String GCM_REGISTER_URL = "https://notification.8villages.com/api/1.0/gcm/register?state=";
    public static final String GCM_SENDER_ID = "444956506713";
    public static final String GCM_API_KEY = "AIzaSyAN3QCnrPt0jeUG7SPfOLOKoT6iX_1cc7g";

    String accessToken = "QaJrGKL3kT_LbEogb2NbWWMYxxM.";
    String accessTokenSecret = "cQYxRN_sArUAtkFUlm3fuXtQPWypJ33-4vu0z2LgpK0.";
    ...
    public static final String USER_FORUMS = "user_forums";
