...
import com.example.toshiba.ternakku.ui.Tambah_Kandang;
import com.example.toshiba.ternakku.ui.adapter.Adapter_Kandang_List;
...
public class KandangFragment extends Fragment {
    ...
    Adapter_Kandang_List adapter;
    List<ItemRow> itemData;

    public KandangFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_kandang, container, false);

        fabBtn = (FloatingActionButton) root.findViewById(R.id.fabbuttontambahkandang);
        ...
        fabBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent post = new Intent(getActivity(), Tambah_Kandang.class);
                startActivity(post);
            }
        });

        swipelistview = (SwipeListView) root.findViewById(R.id.example_swipe_lv_list_kandang);
        itemData=new ArrayList<ItemRow>();
        adapter=new Adapter_Kandang_List(getActivity().getApplicationContext(),R.layout.costum_row_kandang,itemData);
    ...
    private void pindahPage() {
        ...
        Intent intenn = new Intent(getActivity(), Tambah_Kandang.class);
    ...
    private void updateList() {
        ...
        adapter=new Adapter_Kandang_List(getActivity(),R.layout.costum_row_ternak,itemData);
    ...
    private void Gokamera(View view, final int pos) {
    }
